package cn.org.aischool.utils.token;
 ...
 * 
 * @author huangliyang
 * @Description 获取百度access token的类
 * @Version 
 * @Date 2019年2月19日
 */
//@Component
public class BaiDuTokenUtil {
    ...
    public static String getAuth() {
        ...
        String clientId = ConstantCfg.API_KEY;
        // 官网获取的 Secret Key 更新为你注册的
        String clientSecret = ConstantCfg.SECRET_KEY;
    ...
    public void createToken(String[] args) {
        ...
        baiDuTokenService.updateToken(getAuth(clientId, clientSecret));
	}
